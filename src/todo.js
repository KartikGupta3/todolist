...
export const TodoList = () => {
  return (
    <div className="bg-[#2C2C2C] w-screen h-screen">
      <div className="flex flex-col gap-32 p-8">
        ...
        <div className="flex flex-col gap-9 items-center justify-center">
          <div className="flex flex-row items-center pl-20">
            <input className="bg-white w-[720px] h-[40px] rounded-full text-left p-4"></input>
            <button className="bg-[#4F4F4F] w-[90px] h-[40px] rounded-full text-white -translate-x-16">
          ...
          <div className="flex flex-col gap-9 p-24">
            <div className="flex flex-row items-center pl-8">
              ...
              <button className="bg-gray-300 rounded-lg -translate-x-4">
                <svg
                  class=""
                  width="30"
                  height="30"
